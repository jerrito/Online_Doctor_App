class AppStrings {
  ...
  static String noAccountFoundErrorText =
      "No user account found for this phone number.";
  ...
  static String accountExistErrorMessage =
